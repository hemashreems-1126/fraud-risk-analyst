...
- Recall: 59% - caught 13 of 22 actual fraud cases in the test set
- False positives: 9 - each one means a legitimate customer's transaction gets held for manual review
